package com.malonwright.albums.controllers;
...
import com.malonwright.albums.models.Album;
import com.malonwright.albums.models.User;
import com.malonwright.albums.services.AlbumService;
import com.malonwright.albums.services.UserService;
...
public class HomeController {
	...
	@Autowired
	private UserValidator uService;
	
	@Autowired UserService validator;
	...
	public String register(@Valid @ModelAttribute("user") User user, BindingResult result, HttpSession session) {
		...
		User newUsser = this.uService.registerUser("user__id", newUser.getId());
		return "redirect:/dashboard";
	}
	@PostMapping("/login")
	public String login(HttpSession session, @RequestParam("lemail")String email, @RequestParam("lpassword")String password) {
